...
module.exports = {
  ...
  */
  head: {
    title: 'Jakub Jabłoński Portfolio',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { hid: 'description', name: 'description', content: 'Personal protfolio of web developer Jakub Jabłoński.' }
    ],
    link: [
      ...
      // { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Fira+Sans+Condensed:700|Overpass|Montserrat+Alternates:400,500' }
    ]
  },
